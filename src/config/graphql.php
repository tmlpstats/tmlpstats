...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'regions' => 'TmlpStats\GraphQL\Query\RegionsQuery',
                'adminRegion' => 'TmlpStats\GraphQL\Query\AdminRegionQuery',
            ],
            'mutation' => [
    ...
    //
    'types' => [
        'TmlpStats\GraphQL\Definitions\DateType',
        'TmlpStats\GraphQL\Type\RegionType',
        'TmlpStats\GraphQL\Type\RegionQuarterType',
        'TmlpStats\GraphQL\Type\ScoreboardLockType',
        'TmlpStats\GraphQL\Type\WeekLockType',
        'TmlpStats\GraphQL\Type\AdminRegionQuarterType',
        'TmlpStats\GraphQL\Type\AdminRegionType',
