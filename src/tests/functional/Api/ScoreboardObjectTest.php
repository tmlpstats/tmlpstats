...
class ScoreboardObjectTest extends FunctionalTestAbstract
{
    ...
    public function testSetScoreboardLockQuarter_works()
    {
        ...
        $first = $value['reportingDates'][0];
        $this->assertEquals('2016-03-04', $first['reportingDate']);
        $this->assertEquals(true, $first['weeks'][0]['editActual']);
    }
    ...
    public function testGetScoreboardLockQuarter_typical()
    {
        ...
        $week1 = $value->getWeek(Carbon::createFromFormat('Y-m-d', '2016-03-04'), Carbon::createFromFormat('Y-m-d', '2016-03-04'));
