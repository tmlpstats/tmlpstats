...
<div class="form-group">
    ...
    <div class="col-sm-5">
        {!! Form::input('date', 'start_weekend_date', isset($quarter) ? $quarter->startWeekendDate->format('Y-m-d') : null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        {!! Form::input('date', 'classroom1_date', isset($quarter) ? $quarter->classroom1Date->format('Y-m-d') : null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        {!! Form::input('date', 'classroom2_date', isset($quarter) ? $quarter->classroom2Date->format('Y-m-d') : null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        {!! Form::input('date', 'classroom3_date', isset($quarter) ? $quarter->classroom3Date->format('Y-m-d') : null, ['class' => 'form-control']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        {!! Form::input('date', 'end_weekend_date', isset($quarter) ? $quarter->endWeekendDate->format('Y-m-d') : null, ['class' => 'form-control']) !!}
    </div>
</div>
