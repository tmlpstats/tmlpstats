...
return [
    ...
    */
    ...
    'COURSE_START_DATE_CHANGED' => 'Course start date changed from :was to :now. Please put in a comment when you submit with what happened that led to this change.',
