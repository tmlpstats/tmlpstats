...
class CenterTableSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        $centers = array(
            ...
            array('name' => 'MSP','sheet_filename' => 'MSP','abbreviation' => 'MSP','global_region' => 'NA','local_region' => 'East','stats_email' => 'msp.tmlpstats@gmail.com', 'active' => true),
            ...
            array('name' => 'Washington, DC','sheet_filename' => 'WDC','abbreviation' => 'WDC','global_region' => 'NA','local_region' => 'East','stats_email' => 'washingtondc.tmlpstats@gmail.com', 'active' => true),
            ...
            array('name' => 'Dallas','sheet_filename' => 'Dallas','abbreviation' => 'DFW','global_region' => 'NA','local_region' => 'West','stats_email' => 'dfw.tmlpstats@gmail.com', 'active' => true),
            array('name' => 'Denver','sheet_filename' => 'Denver','abbreviation' => 'DEN','global_region' => 'NA','local_region' => 'West','stats_email' => 'den.tmlpstats@gmail.com', 'active' => true),
            ...
            array('name' => 'Houston','sheet_filename' => 'Houston','abbreviation' => 'HOU','global_region' => 'NA','local_region' => 'West','stats_email' => 'hou.tmlpstats@gmail.com', 'active' => true),
        ...
        foreach ($centers as $center) {
            ...
            $newCenter['sheet_version'] = '15.1.1';
